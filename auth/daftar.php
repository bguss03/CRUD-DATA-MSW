...
<div class="container form-wrapper">
  <div class="row justify-content-center">
    <div class="col-12 col-sm-10 col-md-6 col-lg-5">
      <form action="../auth/proses_daftar.php" method="post" class="p-4 border rounded shadow bg-dark">
        ...
        <div class="mb-4">
          ...
          <input type="password" class="form-control bg-dark text-white border-secondary" id="confirm_password" name="confirm_password" placeholder="Ulangi password" required>
        </div>

        <div class="mb-3">
          <button type="submit" class="btn btn-dark w-100 border-white mb-2">Daftar</button>
        </div>

        <div class="text-center">
          Sudah punya akun? <a href="login.php" class="text-decoration-none text-info">Login di sini</a>
        </div>
      </form>
    </div>
  </div>
